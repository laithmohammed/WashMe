...
let Imagelocation = Styled.img`height: 12em;width: 100%;max-height: 100%;vertical-align: middle; align-self: center;border-radius:0.5em;`;
let Servicestit = Styled.text`font-family: 'Noto Sans', sans-serif;font-size:1em;font-weight:bold;color:#0f75bc;text-decoration:none;margin:0.8em 0em;`;
let Text = Styled.text`font-family: 'Noto Sans', sans-serif;font-size:0.8em;font-weight:bold;color:#000;text-decoration:none;margin:0.8em 0em;`;
